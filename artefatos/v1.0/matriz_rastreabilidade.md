...
| V1-RNF-05, V1-RNF-06 | V1-CT-18, V1-CT-37, V1-CT-39 | `pyproject.toml`; diretório `tests/` | `evidencias/testes.txt`; `evidencias/selenium.txt` | 77 execuções; 94,81% incluindo `app/main.py` / implementado |
