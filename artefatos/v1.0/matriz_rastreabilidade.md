...
| V1-RF-19 | V1-CT-32 a V1-CT-35, V1-CT-39 | Implementado em `frontend/` com telas HTML separadas, módulos JS por responsabilidade, integração de sessão e validação no navegador |
...
| V1-RN-30 | V1-CT-32 a V1-CT-35, V1-CT-39 | Implementado com telas de cadastro, login, perfil, catálogo e gestão de itens próprios |
...
| V1-RNF-05, V1-RNF-06 | V1-CT-18, V1-CT-39 | 72 testes aprovados; cobertura total de 94,28%, incluindo validação Selenium |
...
| V1-RNF-15 | V1-CT-32 a V1-CT-35, V1-CT-38, V1-CT-39 | Implementado em `frontend/` como cliente independente, sem etapa de build obrigatória, com entrega estática por Python `http.server` e navegação Selenium |
