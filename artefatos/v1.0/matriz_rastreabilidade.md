...
| V1-RNF-05, V1-RNF-06 | V1-CT-18, V1-CT-37, V1-CT-39 | `pyproject.toml`; diretório `tests/` | `evidencias/testes.txt`; `evidencias/selenium.txt` | 75 testes; 94,15% incluindo `app/main.py` / implementado |
...
| V1-CT-03 | `tests/test_api_usuario.py` — cenário de complemento opcional ainda precisa de teste dedicado | manual/documental | pendente de automação específica |
