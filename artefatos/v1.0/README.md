...
A versão 1.0 tem como meta uma base funcional com usuários e itens eletrônicos. Os itens ficam em coleção própria e os campos de endereço ficam no nível raiz do contrato HTTP, do modelo de domínio e do documento de usuário.
...
- CRUD HTTP de usuários com endereço representado em campos planos em todas as camadas e auditoria temporal;
