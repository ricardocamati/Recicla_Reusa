...
- [x] Obter cobertura superior a 70% — resultado atual: 94,15% em 75 testes, medindo também `app/main.py`.
...
- [x] Confirmar cobertura mínima de 70% após todas as mudanças — resultado atual: 94,15% em 75 testes, com `app/main.py` incluído.
